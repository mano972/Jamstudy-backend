...
public class Constants {
    ...
    public static final String CONFIG_KEY_REGISTER_CONFIRMATION_EMAIL_SUBJECT_LT = "register_confirmation_email_subject_LT";
    public static final String CONFIG_KEY_REGISTER_CONFIRMATION_EMAIL_TEXT_LT = "register_confirmation_email_text_LT";
    public static final String CONFIG_KEY_REGISTER_CONFIRMATION_EMAIL_URL_LT = "register_confirmation_email_url_LT";
    public static final String CONFIG_KEY_RESET_PASS_EMAIL_SUBJECT_LT = "reset_pass_email_subject_LT";
    public static final String CONFIG_KEY_RESET_PASS_EMAIL_TEXT_LT = "reset_pass_email_text_LT";
    public static final String CONFIG_KEY_RESET_PASS_EMAIL_URL_LT = "reset_pass_email_url_LT";
